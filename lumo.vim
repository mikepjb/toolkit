...
let s:highlights = [
      ...
      \['CursorLine', 'none', 'black-light', 'none'],
      \['Search', 'none', 'none', 'underline'],
      \['Visual', 'none', 'black-light', 'none'],
      \['CursorLineNr', 'yellow-light', 'black-light', 'none'],
      ...
      \['Folded', 'none', 'black-light', 'none'],
      \['FoldColumn', 'none', 'black-light', 'none'],
